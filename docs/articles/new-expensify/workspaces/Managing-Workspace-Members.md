...
- **Auditor** – Has read-only access to all workspace editor pages and can view and comment on reports. Auditors cannot change workspace configuration or take operational workflow actions such as approving, paying, or taking control of reports.
