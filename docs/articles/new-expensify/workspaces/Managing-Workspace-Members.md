...
- **Auditor** – Can view and comment on reports, and has read-only access to all workspace editor pages (Overview, Members, Workflows, Categories, Tags, etc.). Auditors cannot change workspace configuration or take operational workflow actions such as approving, paying, or taking control of reports.
