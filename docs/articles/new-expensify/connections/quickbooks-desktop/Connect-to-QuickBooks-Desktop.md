...
**Note:** If you already have QuickBooks Desktop connected on another workspace, you can select an existing connection during the setup process instead of connecting again. 
