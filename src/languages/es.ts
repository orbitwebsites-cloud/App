...
${amount} para ${merchant} - ${date}`,
        ...
        changePinATMTitle: 'Visita un cajero automático',
        changePinATMDescription:
            'Usa tu tarjeta en cualquier cajero automático para completar el cambio de tu PIN. Esto es obligatorio en tu región. Ponte en contacto con <concierge-link>Concierge</concierge-link> si tienes alguna pregunta.',
